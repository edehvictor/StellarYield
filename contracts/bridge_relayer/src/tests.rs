#[cfg(test)]
mod tests {
    use soroban_sdk::{testutils::{Address as _, Ledger}, Address, Env, Vec, BytesN, Symbol, contract, contractimpl};
    use crate::{BridgeRelayer, BridgeRelayerClient, types::Payload, BridgeError};
    ...
    impl MockToken {
        ...
        pub fn balance(_e: Env, _to: Address) -> i128 { 0 }
    }

    fn setup_env(e: &Env) -> (BridgeRelayerClient<'static>, Address, SigningKey, SigningKey, i128, Address) {
        e.mock_all_auths();
